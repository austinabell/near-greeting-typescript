...
interface GreetingFormElements extends HTMLFormControlsCollection {
  fieldset: HTMLInputElement;
  greeting: HTMLInputElement;
}
  ...
  React.useEffect(
    () => {
      ...
      if (window.walletConnection.isSignedIn()) {
        // window.contract is set by initContract in index.tsx
        window.contract
      ...
      <main>
        ...
        <form
          onSubmit={async (event) => {
            ...
            const { fieldset, greeting } = target.elements as GreetingFormElements;
        ...
        <ol>
          <li>
            Look in <code>src/App.tsx</code> and <code>src/utils.ts</code> –
